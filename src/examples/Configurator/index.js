...
function Configurator() {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <SoftBox>
          <SoftTypography variant="h5">AxsosPoint Configurator</SoftTypography>
      ...
      <SoftBox pt={1.25} pb={3} px={3}>
        ...
        <SoftBox mt={3} textAlign="center">
          <SoftBox mb={0.5}>
            <SoftTypography variant="h6">Follow us on social media!</SoftTypography>
          </SoftBox>
          ...
          <SoftBox display="flex" justifyContent="center">
            <SoftBox mr={1.5}>
              <SoftButton
                component={Link}
                href="https://www.instagram.com/axsosacademy/"
                target="_blank"
                rel="noreferrer"
                color="dark"
              >
            ...
            <SoftButton
              component={Link}
              href="https://www.facebook.com/AXSOSAcademy"
              target="_blank"
              rel="noreferrer"
              color="dark"
            >
